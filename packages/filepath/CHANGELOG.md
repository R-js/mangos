...
## version "1.0.13" 2026-may-15 **deprecated it had no typefiles**grep
   ### changed
   - changed: using `@rollup/plugin-typescript` to generate types and map files correctly. (Jacob Bogers <jkfbogers@gmail.com>)


## version "1.0.12" 2026-may-15 **deprecated it had no typefiles**
   ### changed
   - changed `prepublishOnly` to target `prepack` in the package.json so d.ts files do get generated on `npm pack` (Jacob Bogers <jkfbogers@gmail.com>)


## version "1.0.11" 2026-may-15 **deprecated it had no typefiles**
   ### changed
   - Removed `ParsedPathError` (is merged with `ParsedPath`), removing duplicate code (Jacob Bogers <jkfbogers@gmail.com>)
   - Renamed `firstPath` to `parse` and `allPath` to `allPlatforms` removing second optional argument from both functions (Jacob Bogers <jkfbogers@gmail.com>)

## version "1.0.10" 2026-may-12
   ### changed
   - `FileSystem` type exported (Jacob Bogers <jkfbogers@gmail.com>)

## version "1.0.9" 2026-jan-8
   ### changed
   - `PathToken` is renamed `PathTokenImpl` (Jacob Bogers <jkfbogers@gmail.com>)
   - `Token` is now an interface type (Jacob Bogers <jkfbogers@gmail.com>)
